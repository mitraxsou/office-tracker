...
export const GLOBAL_SEARCH_INDEX: GlobalSearchEntry[] = [
  ...
  },
  {
    id: "reports",
    label: "Reports",
    description: "Monthly summaries, visit log, and corrections",
    href: "/reports",
    keywords: ["reports", "monthly", "compliance", "export", "calendar", "summary"],
    group: "pages",
  },
  {
    id: "history",
    label: "Visit history",
    description: "Past visits and report issues",
    href: "/reports?tab=visits",
    keywords: ["history", "visits", "past", "timeline", "report issue"],
    group: "pages",
  },
  {
    id: "reports-corrections",
    label: "Correction requests",
    description: "Track visit correction requests and admin replies",
    href: "/reports?tab=corrections",
    keywords: ["corrections", "correction", "report issue", "admin reply", "visit fix"],
    group: "pages",
  },
  {
    id: "settings",
